...
export const projectData2 = [
    ...
    { id: 7, image: trench, githubUrl: "https://github.com/fiiwebarry", siteUrl: "https://www.ihealthwellness.org/", content: "Trench Housing is a real estate platform designed to connect property agents with house buyers. The website ensures a seamless, interactive, and visually appealing user experience. The platform is optimized, allowing users to easily browse listings and connect with agents. ", },
    { id: 8, image: proof, githubUrl: "https://github.com/fiiwebarry", siteUrl: "https://www.ihealthwellness.org/", content: " Proof Ngo platform was designed to be responsive and user-friendly, supporting Proof in fulfilling its mission. I worked closely with a product designer to ensure an intuitive and visually appealing experience for users, helping to create a functional and impactful website for the community. ", },
    { id: 9, image: abenol, githubUrl: "https://github.com/fiiwebarry", siteUrl: "https://www.ihealthwellness.org/", content: "I Volunteered at iHealth and Wellness Foundation to work on a project that improves patient outcomes for complex diseases through an online medical and wellness care platform. As a frontend developer i worked basically with React.js and collaborated massively with backend developers and product designers ", },];