                ...
                <div className=" mx-auto w-[85%] lg:pt-[40px] pt-[40px] lg:pb-[50px] pb-[30px] ">
                    ...
                    <div className="  container mx-auto lg:flex  lg:flex-row md:flex-row  justify-center md:flex flex  flex-col lg:gap-[100px] md:gap-[100px] lg:mt-9">
                        ...
                        >
                            ...
                            <div className="grid grid-flow-col w-max gap-3 items-center">
                             ...
                             <button className=" grid grid-flow-col w-max items-center bg-Hover-tint text-white gap-3 hover:bg-Hover-tint hover:text-white rounded-md shadow-md border font-bold border-[#F9FAFB]   px-10  p-[5px] text-[15px] lg:text-[20px] py-4 mt-7 font-open-sans">  <SiGooglemeet /> <CalendlyButton/></button>
                            </div>
