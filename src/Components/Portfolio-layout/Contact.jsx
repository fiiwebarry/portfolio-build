...
// import CalendlyButton from "./Components/Portfolio-layout/popupBtn";
                    ...
                    <div className="  container mx-auto lg:flex  lg:flex-row md:flex-row  justify-center md:flex flex  flex-col lg:gap-[100px] md:gap-[100px] lg:mt-9">
                        <div className="mt-[20px] lg:w-[35%]">
                            <div className=" flex flex-col gap-6 ">
                                <div onClick={handleEmailClick} className="rounded-2xl cursor-pointer p-[45px]  shadow-xl  hover:bg-Hover-tint hover:text-white bg-[#ffff] lg:w-[397px]  " data-aos="flip-right">
                                    <div>
                                ...
                                <div onClick={handleWhatsappClick} className="rounded-2xl p-[45px]  cursor-pointer shadow-xl  hover:bg-Hover-tint hover:text-white bg-[#ffff] lg:w-[397px]  " data-aos="flip-right">
                                    <div>
                                ...
                                <div onClick={handleTwitterClick} className="rounded-2xl p-[45px] cursor-pointer  shadow-xl  hover:bg-Hover-tint hover:text-white bg-[#ffff] lg:w-[397px]  " data-aos="flip-right">
                                    <div>
                        ...
                        >
                            ...
                            <div className="grid md:grid-flow-col w-max gap-3 items-center">
                                <button type="submit" className="  mt-[30px] grid justify-items-center bg-[#000] cursor-pointer  hover:bg-Hover-tint hover:text-white text-[#fff] text-[24px] p-3 rounded font-open-sans grid-flow-col gap-2 w-max font-semibold">Send Message
                             ...
                             <button className=" grid grid-flow-col w-max items-center bg-Hover-tint text-white gap-3 hover:bg-Hover-tint hover:text-white rounded-md shadow-md border font-bold border-[#F9FAFB]   px-10  p-[5px] text-[15px] lg:text-[20px] py-4 md:mt-7 font-open-sans">  <SiGooglemeet /> <CalendlyButton/></button>
                            </div>
