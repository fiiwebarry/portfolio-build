...
const Batch = () => {
    ...
    return (
        <div className="lg:pt-[70px] lg:pb-[90px] pt-[20px] pb-[20px] overflow-x-clip">
            <div className=" gap-2  hover:bg-Hover-tint hover:text-white rounded-md items-center lg:w-[220px] w-[190px] h-[70px]  p-2 flex mx-auto justify-center pt-[5px] bg-[#F9FAFB]  border border-[#F9FAFB] shadow-2xl">
                <button className="lg:text-[25px] font-georgia font-bold mt-4"> My Skill Set  </button>
