...
const Batch = () => {
    ...
    return (
        <div className="lg:pt-[70px] lg:pb-[90px] pt-[20px] pb-[20px] overflow-x-clip">
            <div className=" gap-2  hover:bg-Hover-tint cursor-pointer hover:text-white rounded-md items-center lg:w-[220px] w-[190px] h-[70px]  p-2 flex mx-auto justify-center pt-[5px] bg-[#F9FAFB]  border border-[#F9FAFB] shadow-2xl">
                <p className="lg:text-[25px] font-georgia font-bold mt-4"> My Skill Set  </p>
                <span className="mt-4 "><BsRobot className="text-[32px]" /></span>
            </div>
            <div className="  mt-[30px] lg:mt-[60px] lg:px-8  justify-center mx-auto lg:flex lg:justify-between gap-[16px] md:gap-[60px] md:flex flex lg:flex-row  md:flex-row flex-wrap lg:w-8/12 md:w-1/2 w-1/2" >
                ...
                <div>
                    <img className="lg:w-[80px]" src={icon11} alt="" data-aos="zoom-in-up" />
